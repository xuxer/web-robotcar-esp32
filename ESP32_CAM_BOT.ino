...
//const char* ssid = "CMCC-YG9L";
//const char* password = "kdg9eexg";
const char* ssid = "maker373";
const char* password = "xu123456";
...
<html>
    ...
    <table>
      <tr>
        <td colspan="3" align="center">
          <button class="button" onmousedown="toggleCheckbox('forward');" ontouchstart="toggleCheckbox('forward');" onmouseup="toggleCheckbox('stop');" ontouchend="toggleCheckbox('stop');">Forward</button></td>
      </tr>
      <tr>
       <td align="center">
      ...
      <tr>
          ...
          <td>
            <button class="button"  onmousedown="toggleCheckbox('LED');"  > LED </button>
          </td>
      </tr>                   
  ...
  document.addEventListener("keyup", function(event) {
    var keyCode = event.keyCode;
    if(keyCode==87||keyCode==83)//前后电机的停止
      toggleCheckbox("F_B_stop");
    if(keyCode==65||keyCode==68)//左右电机的停止
      toggleCheckbox("R_L_stop");  
    // 将事件触发标志设置为未触发，以便下次按下按键时可以再次触发事件
...
//    digitalWrite(MOTOR_1_PIN_2, 1);
  ...
  else if(!strcmp(variable, "R_L_stop")) {
    Serial.println("R_L_Stop");
    digitalWrite(MOTOR_1_PIN_1, 0);
    digitalWrite(MOTOR_1_PIN_2, 0);
    //analogWrite(MOTOR_2_PIN_1, 0);
    //analogWrite(MOTOR_2_PIN_2, 0);
  }
  else if(!strcmp(variable, "F_B_stop")) {
    Serial.println("F_B_Stop");
    //digitalWrite(MOTOR_1_PIN_1, 0);
    //digitalWrite(MOTOR_1_PIN_2, 0);
    analogWrite(MOTOR_2_PIN_1, 0);
    analogWrite(MOTOR_2_PIN_2, 0);
